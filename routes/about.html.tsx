...
export function aboutRoute(): SitemapRoute<JSXElement> {
  return {
    *routemap(generate) {
          ...
          <article>
            ...
            <section class="mx-auto mt-20 px-8 lg:px-16 max-w-screen-2xl">
              <blockquote class="border-l-4 border-[#26abe8] pl-6 my-12 text-2xl text-gray-700 leading-relaxed italic">
                ...
                <strong class="font-extrabold">we will solve this</strong>.
                Their work ethic is strong, coupled with the desire to be a
                great partner."
              </blockquote>
              ...
              <ul class="gap-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-20">
                <li class="relative p-8">
                  ...
                  <p class="text-gray-600 leading-relaxed">
                    High-quality applications should not require re-writing
                    every few months or years. We design future-forward software
                    system with predictable long-term maintenance.
                  </p>
                  <img
                    src={decor1}
                ...
                <li class="relative p-8">
                  ...
                  <p class="text-gray-600 leading-relaxed">
                    The best version of your software always exists in the
                    future. We provide robust architectures and tools that
                    enable your team to experiment and pivot quickly.
                  </p>
                  <img
                    src={decor2}
                    class="top-0 right-0 absolute w-16 h-16"
                ...
                <li class="relative p-8">
                  ...
                  <p class="text-gray-600 leading-relaxed">
                    ...
                    consequences. We equip your teams with the tools and
                    know-how to minimize regressions and shorten feedback loops.
                  </p>
                  <img
                    src={decor3}
                    class="top-0 right-0 absolute w-16 h-16"
