        ...
        <article>
            ...
            <div class="lg:col-span-7 xl:col-span-6 lg:px-0 pt-10 lg:pt-2 pb-24 sm:pb-8">
              <div class="mx-auto lg:mx-0 max-w-2xl">
                ...
                <p class="mt-6 text-gray-600 text-xl leading-8">
                  Frontside creates cohesive development experiences for Cloud
                  native teams – from local setup and testing to deployment and
                  developer portals, we have you covered
                </p>
              </div>
            </div>
          ...
          <section class="mx-auto mt-20 px-10 max-w-screen-2xl">
            ...
            <div class="justify-items-center items-center gap-y-20 grid grid-cols-2 lg:grid-cols-4 mx-auto mt-10">
              ...
              />
              <img
                src="/assets/client-logos/grayscale-client-logos/resideo-logo-grayscale.svg"
                alt="client logo resideo"
              />
              <img
                src="/assets/client-logos/grayscale-client-logos/honeywell-logo-grayscale.svg"
                alt="client logo honeywell"
              />
              <img
                src="/assets/client-logos/grayscale-client-logos/hsbc-logo-grayscale.svg"
                alt="client logo hsbc"
              />
              <img
                src="/assets/client-logos/grayscale-client-logos/dell-logo-grayscale.svg"
                alt="client logo dell"
              />
              <img
                src="/assets/client-logos/grayscale-client-logos/altschool-logo-grayscale.svg"
                alt="client logo altSchool"
              />
              <img
                src="/assets/client-logos/grayscale-client-logos/ebsco-logo-grayscale.svg"
                alt="client logo Ebsco"
              />
              <img
                src="/assets/client-logos/grayscale-client-logos/sxsw-logo-grayscale.svg"
                alt="client logo SXSW"
              />
              <img
                src="/assets/client-logos/grayscale-client-logos/condenast-logo-grayscale.svg"
                alt="client logo Condenast"
              />
              <img
          ...
          <section class="bg-gray-50 mt-24 px-4 py-15 md:py-20 lg:py-24 xl:py-30">
            <div class="items-center gap-24 grid grid-cols-1 md:grid-cols-2 m-auto mt-24 md:max-w-5xl">
              <div class="px-4">
                ...
                <p class="py-4 text-gray-600 text-lg leading-8">
                  Being Cloud native comes with its own challenges, especially
                  for your developers. Frontside brings in cross-functional
                  consultants who'll help you remove bottlenecks throughout your
                  workflow and propose game-changing strategies to boost your
                  teams' success.
                </p>
              </div>
            ...
            <div class="items-center gap-24 grid grid-cols-1 md:grid-cols-2 m-auto mt-24 md:max-w-5xl">
              <div class="px-4">
                ...
                <p class="py-4 text-gray-600 text-lg leading-8">
                  ...
                  work, but QA is a significant source of frustration. Using
                  Open Source technologies, Frontside helps teams move tests
                  inside the development cycle while making them both fast and
                  reliable.
                </p>
              </div>
            ...
            <div class="items-center gap-24 grid grid-cols-1 md:grid-cols-2 m-auto mt-24 md:max-w-5xl">
              <div class="px-4">
                ...
                <p class="py-4 text-gray-600 text-lg leading-8">
                  Most companies have great developers on their teams but lack
                  the leadership to identify improvement opportunities and
                  implement change. Frontside offers solutions cultivated from
                  our network of enterprise partners and Open Source maintainers
                  to create and nurture an Inner Source culture within your
                  organization.
                </p>
              </div>
              ...
              <div class="mx-auto px-6 lg:px-8 max-w-7xl">
                <div class="mx-auto max-w-2xl lg:text-center">
                  ...
                  <p class="mt-6 text-gray-600 text-lg leading-8">
                    We help you adopt and extend Backstage to fit your
                    ...
                    <div class="flex flex-col">
                      ...
                      <dd class="flex flex-col flex-auto mt-4 text-gray-600 text-base leading-7">
                        <p class="flex-auto text-lg">
                          ...
                          relationship visible and actionable for everyone.
                        </p>
                    ...
                    <div class="flex flex-col">
                      ...
                      <dd class="flex flex-col flex-auto mt-4 text-gray-600 text-base leading-7">
                        <p class="flex-auto text-lg">
                          ...
                          frontiers for software organizations that guarantee
                          long-term success.
                        </p>
                        <img
                          class="w-60 sm:w-60 h-auto"
                          src={backstageDerisk}
                          alt=""
                        />
                      </dd>
