...
export function codeOfConductRoute(): JSXHandler {
  return function* () {
        ...
        <article class="mx-auto px-8 lg:px-16 py-16 max-w-4xl">
          <header class="mb-12">
            ...
            <p class="text-gray-600 text-xl leading-relaxed">
              All participants of the Frontside Community are expected to abide
              by our Code of Conduct, both online and during in-person events
              that are hosted and/or associated with Frontside.
            </p>
          </header>
          ...
          <div class="mb-8 text-gray-700 leading-relaxed prose prose-lg max-w-none">
            ...
            <p>
              ...
              enforcement at{" "}
              <em>conduct @ frontside.com</em>. All complaints will be reviewed
