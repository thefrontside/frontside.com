...
export function codeOfConductRoute(): SitemapRoute<JSXElement> {
  return {
    *routemap(generate) {
    ...
    handler: function* () {
      let AppHtml = yield* useAppHtml({
        title: "Code of Conduct - Frontside",
        description:
          "All participants of the Frontside Community are expected to abide by our Code of Conduct",
          ...
          <article class="mx-auto px-8 lg:px-16 py-16 max-w-4xl">
            <header class="mb-12">
              ...
              <p class="text-gray-600 text-xl leading-relaxed">
                All participants of the Frontside Community are expected to
                abide by our Code of Conduct, both online and during in-person
                events that are hosted and/or associated with Frontside.
              </p>
            </header>
            ...
            <div class="mb-8 text-gray-700 leading-relaxed prose prose-lg max-w-none">
              ...
              <p>
                ...
                for enforcement at{" "}
                <em>conduct @ frontside.com</em>. All complaints will be
              ...
              <p>
                ...
                <a href="https://www.contributor-covenant.org/">
                  <strong>Contributor Covenant</strong>
              ...
              <p>
                ...
                <a href="https://github.com/mozilla/diversity">
                  <strong>Mozilla's code of conduct enforcement ladder</strong>
                </a>.
              </p>
              <p>
                ...
                <a href="https://www.contributor-covenant.org/faq">
                  <strong>https://www.contributor-covenant.org/faq</strong>
                </a>. Translations are available at{" "}
