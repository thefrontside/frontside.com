...
export function personRoute(): JSXHandler {
  return function* () {
    ...
    let AppHtml = yield* useAppHtml({
      ...
      ogImage: person.img || "/assets/index-meta-home-cloud-native.png",
      twitterXImage: person.img || "/assets/index-meta-home-cloud-native.png",
      author: person.name,
    });
            ...
            <div class="lg:col-span-7 xl:col-span-6 lg:px-0 pt-10 lg:pt-2 pb-24 sm:pb-8">
              <div class="mx-auto lg:mx-0 max-w-2xl">
                ...
                <h2 class="mt-4 font-bold text-2xl text-blue-primary">
                  {person.alumnus ? "Frontside Alumnus" : person.title}
                </h2>
