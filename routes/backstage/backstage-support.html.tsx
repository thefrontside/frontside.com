...
export function backstageSupportRoute(): JSXHandler {
  return function* () {
    ...
    let backstageRibbon = "../../assets/img/backstage-support/artboard-43.png";
          ...
          <section class="bg-gray-50 mt-24 px-4 py-15 md:py-20 lg:py-24 xl:py-30">
            ...
            <div class="items-center gap-24 grid grid-cols-1 md:grid-cols-2 m-auto mt-24 md:max-w-5xl">
              <div class="px-4">
                ...
                <p class="py-4 text-gray-600 text-lg leading-8">
                  ...
                  comes a learning curve that can be difficult to master without
                  help. Frontside gives your team the information they need to
                  be productive with Backstage.
                </p>
              </div>
            ...
            <div class="items-center gap-24 grid grid-cols-1 md:grid-cols-2 m-auto mt-24 md:max-w-5xl">
              <div class="px-4">
                ...
                <p class="py-4 text-gray-600 text-lg leading-8">
                  Companies are using Backstage to improve developer experience,
                  improve employee retention and build Internal Developer
                  Platforms. Frontside has seen firsthand how successful
                  Backstage adopters design their roadmaps.
                </p>
              </div>
              <img
            ...
            <div class="items-center gap-24 grid grid-cols-1 md:grid-cols-2 m-auto mt-24 md:max-w-5xl">
              <div class="px-4">
                ...
                <p class="py-4 text-gray-600 text-lg leading-8">
                  ...
                  Backstage. Frontside keeps your team unblocked by contributing
                  changes to the Backstage project so you can always upgrade and
                  quickly get the latest features.
                </p>
              </div>
            ...
            <div class="items-center gap-24 grid grid-cols-1 md:grid-cols-2 m-auto mt-24 md:max-w-5xl">
              <div class="px-4">
                ...
                <p class="py-4 text-gray-600 text-lg leading-8">
                  As your Backstage project grows, so does the risk of breaking
                  existing features. Reliable testing practices can catch
                  problems before they impact your users' productivity.
                  Frontside helps DX teams implement Backstage ingestion and
                  integration testing practices that give you confidence without
                  blocking your team from shipping new Backstage features.
                </p>
              </div>
              ...
              <div class="bg-white shadow-lg p-8 rounded-lg">
                ...
                <div>
                  <p class="mb-4 text-gray-700 text-lg italic">
                    I learned more working with Frontside for six months than I
                    have in six years.
                  </p>
              ...
              <table class="mx-auto border-collapse w-full max-w-5xl">
                <thead>
                  <tr>
                    ...
                    <th class="p-4">
                      <img src={supportTierGold} alt="" class="mx-auto w-20" />
                    </th>
                    <th class="p-4">
                      <img
