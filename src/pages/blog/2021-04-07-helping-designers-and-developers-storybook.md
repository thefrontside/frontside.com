...
For instance, you can implement a `@developerStory` decorator that would move any story you apply it to a special directory with a `.docs.stories.js` extension, and perform the necessary style adjustments to it when built. And you can do this all with a single line of code! It looks like Alladin’s genie (or rather Storybook’s genie) came through for us.
