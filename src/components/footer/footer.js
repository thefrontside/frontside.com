  ...
  return (
    <footer className="footerwrapper w-container">
      <nav className="navigation">
        ...
        <a href="/consulting" className="footerlink">
          Consulting
        </a>
        ...
        <a href="/podcast" className="footerlink">
          Podcast
        </a>
      ...
      <a href="/" className="footer-symbol" aria-label="visit homepage">
        <img src={FSIcon} width="32.5" alt="" className="image-6" />
      </a>
