      ...
      <content>
        <h4 className="case-study-call--title">
          <Link to="/blog/2019-12-11-case-study-bluetooth-simulation/">
            <strong className="case-study-call--label">Case study</strong>
            Facilitating the next generation of Bluetooth-connected apps
          </Link>
        </h4>
        <p>
          Developing UIs for connected devices can be challenging. We devised a
          solution based on simulation, and partnered up with Open Source
          contributors to bring our client and the community a library built by
