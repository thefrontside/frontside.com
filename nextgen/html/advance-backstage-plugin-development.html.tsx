      ...
      <section class="grid lg:grid-cols-[2fr_1fr] mb-5 px-4 md:max-w-4xl xl:max-w-screen-2xl m-auto text-left">
        <div class="md:order-2 lg:order-1">
          ...
          <p class="pr-8 mt-5 mb-10 tracking-wide text-xl text-blue-primary prose">
            Master Backstage plugin development, born from our real-world,
            hands-on training sessions and engagements with elite enterprise
            clients. This isn't just theory—it's a proven blueprint. Dive into a
            workshop rich in best practices, insights, strategies, and
      ...
      <section class="mt-24 px-8 md:mt-16 md:grid md:grid-cols-2 gap-8 md:mx-auto md:max-w-5xl">
        ...
        <div class="flex flex mt-4 md:mt-0">
          <div class="flex items-center bg-pink-100 rounded-full p-2 w-8 h-8 shrink-0">
            ...
            >
              <path
                d="M10.7548 6.4263C11.5352 5.64589 12.8005 5.64654 13.5808 6.42691C14.3612 7.20727 14.3619 8.47254 13.5814 9.25295C12.801 10.0334 11.5358 10.0327 10.7554 9.25235C9.97503 8.47198 9.97438 7.20672 10.7548 6.4263ZM12.8737 7.13401C12.4835 6.74379 11.8514 6.7439 11.4619 7.13341C11.0724 7.52292 11.0723 8.15502 11.4625 8.54524C11.8527 8.93547 12.4848 8.93536 12.8743 8.54585C13.2638 8.15634 13.264 7.52424 12.8737 7.13401Z"
                fill="#14315D"
                stroke="#14315D"
                stroke-width="0.5"
              />
              <path
                d="M11.7488 14.505C11.1919 14.769 10.506 14.6707 10.0453 14.2099L9.43602 13.6007L8.70399 14.8208C8.62478 14.9529 8.48915 15.041 8.33633 15.0599C8.18352 15.0787 8.03055 15.026 7.92168 14.9172L5.09099 12.0865C4.98209 11.9776 4.92945 11.8246 4.94831 11.6717C4.96716 11.5189 5.0554 11.3832 5.18751 11.304L6.40795 10.5726L5.79811 9.96276C5.33737 9.50202 5.23902 8.81611 5.50306 8.25924L4.38338 7.13957C4.18812 6.9443 4.18812 6.62772 4.38338 6.43246L5.44324 5.3726C6.36626 4.44958 7.7408 4.25328 8.85587 4.78368L9.79332 3.84623C11.4495 2.19003 13.8883 1.59039 16.1237 2.28975C16.8845 2.52777 17.4802 3.12355 17.7183 3.88432C18.4176 6.11969 17.818 8.55852 16.1618 10.2147L15.2244 11.1521C15.755 12.2672 15.5587 13.6419 14.6356 14.5649L13.5757 15.6248C13.3805 15.8201 13.0639 15.8201 12.8686 15.6248L11.7488 14.505ZM15.8251 3.24413C13.9449 2.65588 11.8935 3.16026 10.5004 4.55334L9.68493 5.36884L9.6887 5.3726L8.9816 6.07971L8.97782 6.07595L6.8559 8.19787L6.85967 8.20164L6.45718 8.60412C6.31155 8.79989 6.32756 9.07799 6.50522 9.25565L10.7524 13.5028C10.9304 13.6809 11.2093 13.6966 11.4052 13.5499L11.8066 13.1485L11.8102 13.1521L13.9321 11.0302L13.9285 11.0266L14.6356 10.3195L14.6392 10.3231L15.4547 9.50761C16.8478 8.11452 17.3521 6.06315 16.7639 4.18291C16.6238 3.73502 16.273 3.38426 15.8251 3.24413ZM12.5173 13.8592L13.2222 14.5641L13.9285 13.8578C14.4513 13.335 14.6245 12.5951 14.4481 11.9284L12.5173 13.8592ZM8.07956 5.56C7.41292 5.38376 6.67306 5.55699 6.15034 6.07971L5.44404 6.78601L6.14879 7.49076L8.07956 5.56ZM8.70714 12.8718L7.13691 11.3016L6.25115 11.8324L8.17594 13.7572L8.70714 12.8718Z"
                fill="#14315D"
                stroke="#14315D"
                stroke-width="0.5"
              />
              <path
                d="M5.80269 14.9121C5.99795 14.7169 5.99795 14.4003 5.80269 14.205C5.60743 14.0098 5.29085 14.0098 5.09559 14.205L3.32742 15.9732C3.13215 16.1685 3.13215 16.485 3.32742 16.6803C3.52268 16.8756 3.83926 16.8756 4.03452 16.6803L5.80269 14.9121Z"
                fill="#14315D"
                stroke="#14315D"
                stroke-width="0.5"
              />
              <path
                d="M4.3874 12.79C4.58266 12.9853 4.58266 13.3019 4.3874 13.4972L3.6785 14.206C3.48324 14.4013 3.16666 14.4013 2.9714 14.206C2.77614 14.0108 2.77614 13.6942 2.9714 13.4989L3.68029 12.79C3.87556 12.5948 4.19214 12.5948 4.3874 12.79Z"
                fill="#14315D"
                stroke="#14315D"
                stroke-width="0.5"
              />
              <path
                d="M7.21809 16.3276C7.41335 16.1324 7.41335 15.8158 7.21809 15.6205C7.02283 15.4253 6.70624 15.4253 6.51098 15.6205L5.80209 16.3294C5.60682 16.5247 5.60682 16.8413 5.80209 17.0365C5.99735 17.2318 6.31393 17.2318 6.50919 17.0365L7.21809 16.3276Z"
                fill="#14315D"
                stroke="#14315D"
                stroke-width="0.5"
              />
      ...
      <section class="mt-24 px-8 md:mt-16 md:grid md:grid-cols-2 gap-x-24 gap-y-8 md:mx-auto md:max-w-5xl">
        ...
        <div class="flex mt-4 md:mt-0">
          <div class="flex items-center bg-pink-100 rounded-full p-2 w-8 h-8 shrink-0">
            ...
            >
              <path
                d="M3 8.5C3 4.35786 6.35786 1 10.5 1C14.6421 1 18 4.35786 18 8.5C18 12.6421 14.6421 16 10.5 16C10.4668 16 10.4336 15.9998 10.4005 15.9994C10.5633 15.6808 10.6959 15.3442 10.7947 14.9934C14.2478 14.8394 17 11.9911 17 8.5C17 4.91015 14.0899 2 10.5 2C7.00897 2 4.16073 4.75214 4.00657 8.20514C3.6558 8.30386 3.31924 8.43651 3.00064 8.5993C3.00022 8.56625 3 8.53315 3 8.5ZM10.5 4C10.7761 4 11 4.22386 11 4.5V8H13.5C13.7761 8 14 8.22386 14 8.5C14 8.77614 13.7761 9 13.5 9H10.5C10.2239 9 10 8.77614 10 8.5V4.5C10 4.22386 10.2239 4 10.5 4ZM5 9.0275C2.75002 9.2762 1 11.1837 1 13.5C1 15.9853 3.01472 18 5.5 18C7.98528 18 10 15.9853 10 13.5C10 11.1837 8.24998 9.2762 6 9.0275V12.7929L6.64645 12.1464C6.84171 11.9512 7.15829 11.9512 7.35355 12.1464C7.54882 12.3417 7.54882 12.6583 7.35355 12.8536L5.85355 14.3536C5.65829 14.5488 5.34171 14.5488 5.14645 14.3536L3.64645 12.8536C3.45118 12.6583 3.45118 12.3417 3.64645 12.1464C3.84171 11.9512 4.15829 11.9512 4.35355 12.1464L5 12.7929V9.0275ZM3.5 15H7.5C7.77614 15 8 15.2239 8 15.5C8 15.7761 7.77614 16 7.5 16H3.5C3.22386 16 3 15.7761 3 15.5C3 15.2239 3.22386 15 3.5 15Z"
                fill="#14315D"
                stroke="#14315D"
                stroke-width="0.5"
              />
...
function H2(
  ...
  return (
    <h2
      class={`${classes} font-black text-blue-primary text-3xl md:text-5xl leading-none tracking-tight`}
    >
      {children}
    </h2>
  );
