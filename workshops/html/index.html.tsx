  ...
  return (
    <div class="prose m-auto">
      ...
      <section>
        <h1>About</h1>
        <p>
          This workshop offers an in-depth exploration of Backstage
          plugin development. It is designed for experienced users
          seeking to expand their skills and fully leverage the
          powerful feature set of Backstage. By attending this
          workshop, you will not only build your confidence in
      ...
      <section>
        <h1>Instructors</h1>
        <p>
          Our team of experienced instructors have extensive knowledge
          and hands-on experience in plugin development for
          Backstage. Stay tuned for more details!
        </p>
      </section>
      <section>
        <h1>Registration/Booking</h1>
        <p>
          Registration details coming soon. Don't miss out on this
          unique opportunity to become a Backstage plugin development
          expert!
        </p>
      </section>
      <section>
        <h1>Testimonials/Reviews</h1>
        We value feedback from our participants. Check back soon to hear about their transformative experiences in our workshops.
      </section>
      <section>
        <h1>Prerequisites</h1>
        <p>
          ...
          <ul>
            ...
            <li>Have a basic understanding of React, Typescript, MonoRepos, Webpack, SQL, and Node.</li>
          </ul>
        </p>
      </section>
      <section>
        <h1>FAQs</h1>
        <p>
          Have questions? We'll have a detailed FAQ section soon to
      ...
      <section>
        <h1>Contact Us</h1>
        <p>
          Need more information? Feel free to reach out to us at [Your
