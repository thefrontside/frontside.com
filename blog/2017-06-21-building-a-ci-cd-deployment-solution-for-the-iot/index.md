...
<figure class="figure" alt="add public key from github to resin.io dashboard">
  <img class="figure-img img-fluid" src="resin_1-add-public-key-to-resin.png"/>
...
<figure class="figure" alt="create application in resin.io dashboard">
  <img class="figure-img img-fluid" src="resin_2-create-app-in-resin.png"/>
...
<figure class="figure" alt="download resinOS image">
  <img class="figure-img img-fluid" src="resin_3-download-resinOS.png"/>
...
<figure class="figure" alt="select resinOS build and config image">
  <img class="figure-img img-fluid" src="resin_4-pick-resinOS-and-config.png"/>
...
<figure class="figure" alt="burn resinos image using etcher">
  <img class="figure-img img-fluid" src="resin_5-burn-resinOS-img-using-etcher.png"/>
...
<figure class="figure" alt="device is connected to resin.io">
  <img class="figure-img img-fluid" src="resin_6-device-is-connected.png"/>
...
<figure class="figure" alt="list of all devices connected in application">
  <img class="figure-img img-fluid" src="resin_7-devices-in-list-within-each-app.png"/>
...
<figure class="figure" alt="resin deploys code to device">
  <img class="figure-img img-fluid" src="resin_8-resin-complete-containerizing-code.png"/>
...
<figure class="figure" alt="project in circleci dashboard">
  <img class="figure-img img-fluid" src="circle_1-circleci-project-list.png"/>
...
<figure class="figure" alt="ssh permissions for project in circleci">
  <img class="figure-img img-fluid" src="circle_2-select-ssh-permissions.png"/>
...
<figure class="figure" alt="add private ssh-key to circleci">
  <img class="figure-img img-fluid" src="circle_3-add-ssh-private-key.png"/>
...
<figure class="figure" alt="add private ssh-key to circleci">
  <img class="figure-img img-fluid" src="circle_4-add-public-key.png"/>
...
<figure class="figure" alt="Image map of deployment solution">
  <img class="figure-img img-fluid" src="resin-circleci-github.png"/>
