...
![Deno for publishing to Deno ecosystem and Node for publishing to Node ecosystem](dev-publish-silo.png)
...
![Deno for publishing to both Deno and Node package managers](one-tool-for-both.png)
...
![The 1.0.0 git tag causes a 1.0.0 version on both deno.land and npmjs.org](tag-to-publish.png)
